      ...
      <li class="mb-10 ml-6">
        ...
        >
          <img
            ...
            src="~assets/devicon/work.svg"
          />
        </span>
        <h3
          class="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white"
        >
          {{item.position}}  <span class="bg-yellow-300 text-black text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-white-800 ml-3">@{{item.companyName}}</span>
          <div v-if="item.endDate=='present'">
          <span
            class="bg-green-600 text-white text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3"
            >Currently</span
          >
          </div>
        </h3>
        <time
          class="block mb-2 text-sm font-bold leading-none text-grey-400 dark:text-grey-500"
          >
